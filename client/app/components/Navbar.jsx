...
const [togglecontect,settogglecontect]=useState("")
  ...
  <div className='border-[#000000d1] border-[2px] p-1 rounded-full relative  group ' onMouseEnter={()=>settogglecontect("contact")}>
    <MdOutlineHeadphones className='    text-2xl ' />


     <div onMouseLeave={()=>settogglecontect("")} className={`  fixed right-[20%]   top-16 bg-white translate-y-8 ${togglecontect=="contact"?"  scale-100":" scale-0"}  origin-top-left duration-300  `}>
     <div class="flex items-center px-6 py-3 bg-gray-900">
            <svg class="h-6 w-6 text-white fill-current" viewBox="0 0 512 512">
                <path d="M256 48C150 48 64 136.2 64 245.1v153.3c0 36.3 28.6 65.7 64 65.7h64V288h-85.3v-42.9c0-84.7 66.8-153.3 149.3-153.3s149.3 68.5 149.3 153.3V288H320v176h64c35.4 0 64-29.3 64-65.7V245.1C448 136.2 362 48 256 48z"/>
            </svg>
            <h1 class="mx-3 text-white font-semibold text-lg">Contect Us</h1>
        </div>
        <div class="py-4 px-6">
            <div className='flex items-center   gap-4'>
              ...
              <a class=" text-lg cursor-pointer text-gray-700" href="tel:+4733378901"> +91 9876543210</a>
              </div>
            </div>
         ...
         <div className="bg-white rounded-lg shadow-lg max-w-md lg:max-w-xl w-full relative">
           ...
           <div className='p-4'>
             <div className="flex mb-4 space-x-2">
               <button
                 className={`w-full py-2 ${activeTab === 'login' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700'} rounded-lg`}
                 onClick={() => handleTabSwitch('login')}
               >
                 Login
               </button>
               <button
                 className={`w-full py-2 ${activeTab === 'signUp' ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-700'} rounded-lg`}
             ...
             <form onSubmit={handleFormSubmit}>
               {activeTab === 'signUp' ? (
                 <>
                   ...
                   <button onClick={signuphandel} className="w-full bg-orange-500 text-white py-2 rounded-lg mb-4">Sign Up</button>
                 </>
               ) : (
                 <>
                   <div className="mb-4">
                   ...
                   <button onClick={Loginhandel} className="w-full bg-orange-500 text-white py-2 rounded-lg mb-4">Login</button>
                 </>
               )}
             </form>
